...
while respuesta2.upper()=='SI' :
    ...
    match opcion:
        case 1:
            ...
            datos_guardados = (folio, fecha_act, cliente, servicios, monto)
            
    
            tabla = PrettyTable()
        
            tabla.field_colum = ['Descripción', 'Datos']
            ...
            while True:
                ...
                if respuesta == 1:
                    ...
                    nota_periodo = [folio, fecha_act, cliente, servicio, monto]
                ...
                respuesta_nota = input('¿Desea agregar otra nota? SI/NO: ')
